...
class RoombaBehaviorTree(BehaviorTree):
    ...
    def __init__(self):
        ...
        forward_behavior = MoveForwardNode()
        spiral_behavior = MoveInSpiralNode()
        go_back_behavior = GoBackNode()
        rotate_behavior = RotateNode()

        first_selector.add_child(first_sequence)
        first_selector.add_child(second_sequence)
        first_sequence.add_child(forward_behavior)
        first_sequence.add_child(spiral_behavior)
        second_sequence.add_child(go_back_behavior)
        second_sequence.add_child(rotate_behavior)
